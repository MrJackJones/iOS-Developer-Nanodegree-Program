...
//predicate:
        ...
        do {
            ...
            fatalError("Data fetch could not be performed: \(error.localizedDescription)")
        }
    }
    
    // load Imagees from Flickr API:
    @IBAction func reloadImageCollection(_ sender: Any?) {
        
        // delete photos from coreData:
        deletePhotos()
        
        //inital state for collectionView:
    ...
    // reload Collection button state hamdler:
...
extension DetailViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if isEditing {
            ...
            showAlertMessage(message: "tap the edit button to remove")
        }
    }
}
